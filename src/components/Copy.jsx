         ...
         if (containerRef.current.hasAttribute
            ...
            elements.forEach((element) => {
                ...
                split.lines.forEach((line) => {
                    ...
                    line.parentNode.insertBefore(wrapper,
                    line);
            ...
            const createBlockRevealAnimation = (block,
            line, index) => {
                const tl = gsap.timeline({ delay: delay +
                index * stagger});

                tl.to(block, { scaleX: 1, duration:
                duration, ease: "power4.inOut" });
                tl.set(line, { opacity: 1 });
                tl.set(block, { transformOrigin: "right center" });
                tl.to(block, {scaleX: 0, duration: 
                duration, ease: "power4.inOut"});
